...
<?php
				...
				{
					$filter = $_POST['filter'];
					$result = mysqli_query1("SELECT * FROM products where Product like '%$filter%' or Description like '%$filter%' or Category like '%$filter%'");
				}
				else
				{
					$result = mysqli_query1("SELECT * FROM products  where Category='Laptops'");
